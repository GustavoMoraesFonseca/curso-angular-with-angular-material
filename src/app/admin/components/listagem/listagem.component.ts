...
import {  Lancamento } from '../../../shared/models/lamcamento.model';
...
@Component({
  ...
  template: `
    ...
    <div mat-dialog-actions>
      <button mat-button mat-dialog-close (click)="false" tabindex="-1">
        Não
      </button>
      <button mat-button mat-dialog-close (click)="true" tabindex="2">
        Sim
      </button>
    </div>
  `,
